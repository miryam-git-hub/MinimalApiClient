...
options.UseMySql(connectionString, Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.22-mysql")));
...
// הפעלת Swagger אם הסביבה היא פיתוח
...
// יש לוודא שה-CORS מופעל לפני השימוש בנתבים
